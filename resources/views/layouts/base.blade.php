				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+880) 1985-440869" href="tel:+880198544069" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+880) 1985-440869</a>
								</li>
							</ul>
						</div>
										...
										@auth
											@if(Auth::user()->utype ==='ADM')
												<li class="menu-item menu-item-has-children parent" >
													<a title="My Account" href="/user/profile">My account ({{ Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
